...
- Hands-on project work: Participants will work on of two pre-defined projects ("Modelling glacier mass balance with machine learning“, or “Glacier mapping from satellite data using Deep Learning and Random Forests”) or may also design their own project based on their own data in collaboration with the instructors in a “hackathon-type” fashion. 
...
Ellianna Abrahams (Univ. of California, Berkeley)

Jordi Bolibar (Utrecht Univ.)

Regine Hock (Univ of Oslo) 

Konstantin Maslov (Univ. of Twente)

Fernando Pérez (Univ. of California, Berkeley)

Benjamin Robson (Univ. of Bergen)

Facundo Sapienza (Univ. of California, Berkeley)

Thomas Schellenberger (Univ of Oslo)
